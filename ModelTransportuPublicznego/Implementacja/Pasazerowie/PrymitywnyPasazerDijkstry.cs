...
//    public class PasazerDijkstryOld : Pasazer {
//
...
//
//        private PasazerDijkstryOld() {
//            trasaPasazera = new List<Przystanek>();
//        }
//        
//        public PasazerDijkstryOld(IEnumerable<Przystanek> trasaPasazera) : this() {
//            foreach (var p in trasaPasazera) {
//                this.trasaPasazera.Add(p);
//            }
//        }
//
//        public PasazerDijkstryOld(IEnumerable<Przystanek> trasaPasazera, int czasWsiadania, int czasWysiadania) : this(
//            trasaPasazera) {
//            this.czasWsiadania = czasWsiadania;
//            this.czasWysiadania = czasWysiadania;
//        }
//
//        public PasazerDijkstryOld(int czasWsiadania, int czasWysiadania, Przystanek przystanekPoczatkowy, Przystanek przystanekKoncowy, Graf.Graf graf)
...
//        }
//
//        public PasazerDijkstryOld(int czasWsiadania, int czasWysiadania, Przystanek przystanekPoczatkowy,
//            Przystanek przystanekKoncowy, Graf.Graf graf, TimeSpan czasStworzenia)
//            : base(czasWsiadania, czasWysiadania, przystanekPoczatkowy, przystanekKoncowy) {
//            this.graf = graf;
////            trasaPasazera = ZnajdzTrase(graf, czasStworzenia);
//        } 
//
